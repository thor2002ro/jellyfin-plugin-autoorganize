...
internal static class Program
{
    ...
    private static void RegisterTests()
    {
        ...
        Add("SQLite reference matches the Jellyfin 12 shared runtime", () =>
        {
            AssemblyName sqliteReference = typeof(AutoOrganizePlugin).Assembly.GetReferencedAssemblies()
                .Single(reference => reference.Name == "Microsoft.Data.Sqlite");
            Equal(new Version(10, 0, 11, 0), sqliteReference.Version);
        });
